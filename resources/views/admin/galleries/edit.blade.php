<x-backend.layouts.app :title="__('Edit Gallery')">
    <div class="max-w-4xl mx-auto">
        <div class="flex justify-between items-center mb-6">
            <h1 class="text-2xl font-bold">Edit Gallery: {{ $gallery->title }}</h1>
        ...
        <div class="bg-white rounded-lg shadow p-6 space-y-6">
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" name="title:en" id="title_en" value="{{ old('title:en', $gallery->getTranslation('title', 'en')) }}" required
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" name="title:eo" id="title_eo" value="{{ old('title:eo', $gallery->getTranslation('title', 'eo')) }}" required
                               class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500">
                        @error('title:eo')
                        <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                        @enderror
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" name="title:ru" id="title_ru" value="{{ old('title:ru', $gallery->getTranslation('title', 'ru')) }}" required
                        class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500">
                        @error('title:ru')
                        <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                        @enderror
                    ...
                    <div class="mb-4">
                        ...
                        <input type="number" name="year" id="year" value="{{ old('year', $gallery->year) }}" min="1900" max="{{ date('Y') }}"
                               class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500">
                        @error('year')
                        <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                        @enderror
                ...
                <div>
                    ...
                    <div class="mb-4">
                        ...
                        <textarea name="description:eo" id="description_eo" rows="3"
                                  class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500">{{ old('description:eo', $gallery->getTranslation('description', 'eo')) }}</textarea>
                    ...
                    <div class="mb-4">
                        ...
                        <textarea name="description:ru" id="description_ru" rows="3"
                                  class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500">{{ old('description:ru', $gallery->getTranslation('description', 'ru')) }}</textarea>
            ...
            <div class="flex justify-end space-x-3">
                <a href="{{ route('admin.galleries.show', $gallery) }}" class="btn btn-gray">Cancel</a>
