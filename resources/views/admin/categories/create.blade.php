<x-backend.layouts.app :title="__('Create Category')">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                    <div>
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" name="name:en" id="name" value="{{ old('name:en') }}"
                        ...
                        <div class="mb-4">
                            <label for="name_eo" class="block text-sm font-medium text-gray-700 mb-1">Name (Esperanto)</label>
                            <input type="text" name="name:eo" id="name_eo" value="{{ old('name:eo') }}"
                                   class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500" required>
                            @error('name:eo')
                            <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                            @enderror
                        ...
                        <div class="mb-4">
                            <label for="name_ru" class="block text-sm font-medium text-gray-700 mb-1">Name (Russian)</label>
                            <input type="text" name="name:ru" id="name_ru" value="{{ old('name:ru') }}"
                                   class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500" required>
                            @error('name:ru')
                            <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                            @enderror
                        ...
                        <div class="mb-4">
                            <label for="cover" class="block text-sm font-medium text-gray-700 mb-1">Cover Image URL</label>
