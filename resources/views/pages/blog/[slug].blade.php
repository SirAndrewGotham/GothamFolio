...
@push('section-styles')
    <style>
        /* Safer fade-in: start visible but still animate when Alpine works */
        .fade-in {
            opacity: 1;
            transform: translateY(0);
        }

        /* Only apply the hidden state if Alpine is working */
        .fade-in:not(.visible) {
            opacity: 0;
        ...
        .blog-content .featured-image-container img {
            width: 100% !important;
                    ...
                    <div class="sticky top-24 space-y-6">
                        ...
                        <div class="share-buttons">
                            ...
                            <div class="flex space-x-3">
                                ...
                                <a href="https://twitter.com/intent/tweet?url={{ urlencode(url()->current()) }}&text={{ urlencode($post->title) }}" target="_blank" class="w-10 h-10 rounded-lg bg-blue-400 flex items-center justify-center text-white hover:bg-blue-500 transition-colors">
