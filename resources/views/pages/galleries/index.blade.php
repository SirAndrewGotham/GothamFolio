@php
    ...
    // Get categories from existing galleries (similar to blog approach)
...
<x-frontend.layouts.app>
    ...
    setupAnimations() {
        ...
        <!-- Gallery Filters -->
        <section
            class="py-8 border-b border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800 sticky top-16 z-40">
            <div class="fluid-container">
                        ...
                        <div class="flex flex-col lg:flex-row items-center gap-8 fade-in">
                            <div class="lg:w-1/2">
                                <div class="relative rounded-2xl overflow-hidden shadow-2xl">
                                    <img src="{{ $featuredGallery->cover_image }}"
                                    ...
                                    <div
                                        ...
                                        <span
                                            class="px-3 py-1 bg-blue-500 rounded-full text-sm font-medium mb-2 inline-block">
                            ...
                            <div class="lg:w-1/2">
                                ...
                                <div class="grid grid-cols-2 gap-4 mb-6">
                                    <div class="text-center">
                                        <div
                                            class="text-2xl font-bold text-blue-500 mb-1">{{ $featuredGallery->published_images_count }}</div>
                                        <div
                                            class="text-sm text-gray-600 dark:text-gray-400">{{ __('gothamfolio.galleries.stats.total_photos') }}</div>
                                    </div>
                                    <div class="text-center">
                                        <div
                                            class="text-2xl font-bold text-blue-500 mb-1">{{ $featuredGallery->year }}</div>
                                        <div
            ...
            <div class="fluid-container">
                ...
                <div class="grid grid-cols-1 md:grid-cols-4 gap-6 mb-12 fade-in">
                    <div class="bg-white dark:bg-gray-800 rounded-xl p-6 shadow-lg text-center">
                        ...
                        <div
                            class="text-gray-600 dark:text-gray-400">{{ __('gothamfolio.galleries.stats.total_galleries') }}</div>
                    </div>
                    <div class="bg-white dark:bg-gray-800 rounded-xl p-6 shadow-lg text-center">
                        <div class="text-2xl font-bold text-blue-500 mb-2">{{ $totalPhotos }}</div>
                        <div
                            class="text-gray-600 dark:text-gray-400">{{ __('gothamfolio.galleries.stats.total_photos') }}</div>
                    </div>
                    <div class="bg-white dark:bg-gray-800 rounded-xl p-6 shadow-lg text-center">
                        <div class="text-2xl font-bold text-green-500 mb-2">15+</div>
                        <div
                            class="text-gray-600 dark:text-gray-400">{{ __('gothamfolio.galleries.stats.years_experience') }}</div>
                    </div>
                    <div class="bg-white dark:bg-gray-800 rounded-xl p-6 shadow-lg text-center">
                        <div class="text-2xl font-bold text-orange-500 mb-2">12</div>
                        <div
                            class="text-gray-600 dark:text-gray-400">{{ __('gothamfolio.galleries.stats.countries') }}</div>
                    </div>
                </div>

                <!-- Grid View -->
                <div x-show="viewMode === 'grid'" class="gallery-grid fade-in" x-cloak>
                ...
                <!-- Masonry View -->
                <div x-show="viewMode === 'masonry'" class="masonry-grid fade-in" x-cloak>
                    <template x-for="gallery in filteredGalleries" :key="gallery.id">
            ...
            <div class="fluid-container">
                <div class="max-w-4xl mx-auto text-center fade-in">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                        <div class="text-center">
                            <div
                                class="w-16 h-16 rounded-full bg-purple-100 dark:bg-purple-900/30 flex items-center justify-center text-purple-500 mx-auto mb-4">
                        ...
                        <div class="text-center">
                            <div
                                class="w-16 h-16 rounded-full bg-blue-100 dark:bg-blue-900/30 flex items-center justify-center text-blue-500 mx-auto mb-4">
                        ...
                        <div class="text-center">
                            <div
                                class="w-16 h-16 rounded-full bg-green-100 dark:bg-green-900/30 flex items-center justify-center text-green-500 mx-auto mb-4">
            ...
            <div class="fluid-container">
                <div class="max-w-6xl mx-auto">
                    <h2 class="text-3xl font-bold mb-12 text-center fade-in">{{ __('gothamfolio.galleries.equipment') }}
                        & {{ __('gothamfolio.galleries.techniques') }}</h2>
                    <div class="grid grid-cols-1 lg:grid-cols-2 gap-12">
                        <div class="fade-in">
                            ...
                            <div class="space-y-4">
                                ...
                                <div class="flex items-start">
                                    <div
                                        class="w-12 h-12 rounded-lg bg-green-100 dark:bg-green-900/30 flex items-center justify-center text-green-500 mr-4 flex-shrink-0">
                        ...
                        <div class="fade-in">
                            ...
                            <div class="space-y-4">
                                <div class="flex items-start">
                                    <div
                                        class="w-12 h-12 rounded-lg bg-orange-100 dark:bg-orange-900/30 flex items-center justify-center text-orange-500 mr-4 flex-shrink-0">
                                ...
                                <div class="flex items-start">
                                    <div
                                        class="w-12 h-12 rounded-lg bg-red-100 dark:bg-red-900/30 flex items-center justify-center text-red-500 mr-4 flex-shrink-0">
                                ...
                                <div class="flex items-start">
                                    <div
                                        class="w-12 h-12 rounded-lg bg-indigo-100 dark:bg-indigo-900/30 flex items-center justify-center text-indigo-500 mr-4 flex-shrink-0">
