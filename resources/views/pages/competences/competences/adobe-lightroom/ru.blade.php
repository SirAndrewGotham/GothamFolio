                        ...
                        <div class="lg:col-span-2 space-y-8">
                            ...
                            <div class="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-8 fade-in">
                                ...
                                <div class="content-section">
                                    ...
                                    <ul>
                                        <li><strong>Неразрушающее редактирование</strong> — Все изменения обратимы и никогда не изменяют исходные файлы</li>
                            ...
                            <div class="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-8 fade-in">
                                ...
                                <div class="content-section">
                                    <p>
                                        Имея более 15 лет опыта, я освоил как технические, так и творческие аспекты
