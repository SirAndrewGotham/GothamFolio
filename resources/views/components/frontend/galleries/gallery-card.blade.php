<div>
    <!-- Grid column -->
    <a href="{{ url('/portfolio/' . $project->slug) }}" class="block">
        <div
            ...
            <div class="relative overflow-hidden h-56">
                ...
                <div class="absolute top-4 right-4">
                    @php
                        ...
                        $statusClass = $statusColors[$project->status] ?? 'bg-gray-500';
                    @endphp
                    <span class="px-3 py-1 rounded-full text-xs font-medium text-white shadow-lg {{ $statusClass }}">
                         {{ $project->status }}
                     </span>
                </div>
                <div
            ...
            <div class="p-6">
                ...
                @if($project->categories->count() > 0)
                    <div class="flex flex-wrap gap-2 mb-6">
                        @foreach($project->categories->take(4) as $category)
                            <a href="{{ url('/portfolio/competences/' . $category->slug) }}"
                ...
                <div class="flex items-center justify-between text-sm text-gray-500 dark:text-gray-400">
                    ...
                    <div class="flex items-center">
                        ...
                        <a href="{{ url('/portfolio/' . $project->projectType?->slug) }}"
