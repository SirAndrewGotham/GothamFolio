<footer class="bg-gray-900 text-gray-400 py-12 w-full">
    <div class="fluid-container">
        <div class="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
            <div>
                <h4 class="text-white font-bold mb-4">Обо мне</h4>
                <p class="mb-4">
            ...
            <div>
                <h4 class="text-white font-bold mb-4">На связи!</h4>
                <div class="space-y-2">
                    ...
                    <p class="flex items-center">
                        ...
                        <a href="https://wa.me/+77755569244" target="_blank" class="hover:text-white">WhatsApp (для сообщений)</a>
                    </p>
                </div>
            </div>
        ...
        <div class="pt-8 border-t border-gray-800 text-center">
            <p class="text-sm text-gray-400 opacity-75">Copyright © 2025 <strong class="text-white">Sir. Andrew Gotham</strong>. Все права на контент этого сайта охраняются законом.</p>
        </div>
    </div>
</footer>
